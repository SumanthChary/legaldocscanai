  ...
  return <>
      <div className="max-w-4xl mx-auto mb-8 text-center px-4">
        <div className="flex items-center justify-center gap-2 mb-4 flex-wrap">
          ...
          {showEnterpriseTip && <div className="relative group">
      ...
      <div className="grid gap-4 sm:gap-6 grid-cols-1 lg:grid-cols-2 mb-12">
        {features.map((feature, index) => <Card key={index} className="h-full border border-gray-200 hover:border-gray-300 transition-colors">
            <CardHeader className="pb-3 p-4 sm:p-6">
              <UpcomingFeature icon={feature.icon} title={feature.title} description={feature.description} status={feature.status} infoList={feature.infoList} />
            </CardHeader>

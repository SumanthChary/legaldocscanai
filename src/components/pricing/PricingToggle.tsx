...
export const PricingToggle = ({ isAnnual, setIsAnnual }: PricingToggleProps) => {
  return (
    <div className="flex justify-center items-center gap-3 mb-8 md:mb-10 px-4">
      <span className={`text-sm md:text-base ${!isAnnual ? 'font-medium text-gray-900' : 'text-gray-600'}`}>
        Monthly
      </span>
      <Switch 
        id="billing-toggle"
